...
function setMenuBar(pageName) {
    switch (pageName) {
        case "chr":
            $("#breadcrumbContainer").html(`
                <div class='hoverTab'><a href='Flitter.html'>Flitter</a></div>\n
...
function loadHeader() {
    $('header').html("<div class='siteLogoContainer'>" +
        ...
        "           <div class='headerSubTitle' id='headerSubTitle'>55</div>\n" +
