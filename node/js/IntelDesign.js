...
function displaySkillsCloud() {
    ...
    $('#middleColumn').html(`
        <div class='whiteContrastBackground'>
            <h2>My Skills</h2>
            <div id="skillsloadingGif" class="loadingGif"><img src="https://common.ogglebooble.com/img/loader.gif" /></div>
...
function displayMyResume() {
    ...
    $('#middleColumn').html(`
        <div id="resumeSectionContainer" class="resumeContainer">
            <div id="resumeLoadingGif" class="loadingGif"><img src="https://common.ogglebooble.com/img/loader.gif" /></div>
